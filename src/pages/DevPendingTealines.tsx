// Dev version of PendingTealines that uses mock data
...
import { useDevPendingTealines } from '../hooks/useDevMockData';
import { exportToCSV, type ExportColumn } from '../utils/exportUtils';
import { Pagination } from '../components/ui/Pagination';
import { Package } from 'lucide-react';


export function DevPendingTealines() {
  ...
  const { data: pendingResponse, isLoading, isFetching, error, refetch } = useDevPendingTealines(queryParams);
      ...
      {isInteractionLoading ? (
        ...
        <Card>
          ...
          <CardContent className="p-0">
            ...
            <TableHeader>
              <TableRow>
                <TableHead className="px-6 py-3">Created Date</TableHead>
                  ...
                  >
                    <TableCell className="px-6 py-4">
                      <div className="text-sm">
                        {new Date(Number(item.created_ts)).toLocaleDateString()}
                      </div>
                    </TableCell>
                    <TableCell className="px-6 py-4">
                      <div>
